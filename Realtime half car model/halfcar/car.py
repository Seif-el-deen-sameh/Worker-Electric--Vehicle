...
class Car:
    def __init__(self, road_func=None, properties=None):
        ...
        wheelbase = 0.86
        well_center_height = 0.4
        well_radius = 0.4

        front_well_center = -0.4
        chassis = arc(
        ...
        tire_width = 0.32
        tire_aspect = 0.30
        hub_diameter = 0.49      # convert in to m
        ...
        m_c = properties.get("m_c", 200)
        m_f = properties.get("m_f", 5)
        m_r = properties.get("m_r", 5)
        I_zz = properties.get("I_zz", 144)
        m = m_c + m_f + m_r

        k_fs = properties.get("k_fs", 11772)
        k_rs = properties.get("k_rs", 18393)
        k_ft = properties.get("k_ft", 15696)
        k_rt = properties.get("k_rt", 15696)

        c_fs = properties.get("c_fs", 1337)
        c_rs = properties.get("c_rs", 2102)
        c_ft = properties.get("c_ft", 1447)
        c_rt = properties.get("c_rt", 1447)
        ...
        max_speed = properties.get("max_speed", 25)
        max_accel = properties.get("max_accel", 0.9)
        max_decel = properties.get("max_decel", -0.9)

...
class PlotSim:
    def __init__(
        ...
        x_limits = (-1, car.road_profile[0][-1])
        y_limits = (-2, 2)
        ax.set_aspect("equal")
        ...
        lines["road"], = ax.plot(
            road_profile[0], road_profile[1] + road_datum, c=road_color, lw=2
        )
        ...
        annotations["time"] = ax.annotate(
            "", xy=(0.1, 0.93), xycoords="axes fraction"
        )
        ...
        annotations["dist_ft"] = ax.annotate(
            "", xy=(0.43, 0.85), xycoords="axes fraction"
        )
        annotations["dist_mi"] = ax.annotate(
            "", xy=(0.43, 0.81), xycoords="axes fraction"
        )
